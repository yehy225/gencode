...
<head>
	<title><%=${className}Mo.TABLE_ALIAS%>新增</title>
...
<body>
<div class="title01">
	<h2>新增<%=${className}Mo.TABLE_ALIAS%></h2>
</div>
	<form id="form1" action="<@jspEl 'ctx'/>${actionBasePath}/save.${actionExtension}" method="post">
